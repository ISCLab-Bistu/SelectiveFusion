...
if __name__ == '__main__':
    ...
    dataroot = 'E:/task/fusion/SCFusion/images/21_pairs_tno/'
    results_root = r'E:/task/fusion\SCFusion\alpha_tno21'
    #融合地址
    dataset = 'TNO21'
    ir_dir = os.path.join(dataroot, 'ir')

    vi_dir = os.path.join(dataroot, 'vi')
    # f_dir = os.path.join(results_root, dataset)
    f_dir = results_root
    save_dir = r'E:/task/fusion\SCFusion\alpha_tno21'
