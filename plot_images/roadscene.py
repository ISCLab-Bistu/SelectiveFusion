...
def main():
	...
	flag_img = False
	# ################# gray scale ########################################
	test_path = "E:\dataset/fusion/gray/roadscene/Inf/"
	path_auto = args.resume_nestfuse
	output_path_root = "E:/task/fusion\SCFusion\output_image_gray_roadscene/"
	...
	with torch.no_grad():
		...
		for alpha in alpha_list:
			for w_all in w_all_list:
				...
				output_path_list = 'scfusion' + temp + '_roadscene'
