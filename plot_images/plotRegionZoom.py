...
if __name__ == '__main__':
    ...
    line_list = [1]
    scale_list = [3]
    place_list = ['bottom right']
    img_path = r'E:\dataset\fusion\rgb\tno21\Vis/IR2.png'
    img_name = 'vi_tno21.png'


    save_path = r'E:\task\fusion\SKFusion\output_image_tno21\plot_image/'
    save = save_path + img_name
    plotMultiRegion(img_path, region_list=region_list, line_width_list=line_list, color_list=color_list,
                    place_list=place_list, scale_list=scale_list, save_path=save, zoom_bool=zoom_bool)
